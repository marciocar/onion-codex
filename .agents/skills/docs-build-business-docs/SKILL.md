...
Gerar a arquitetura de contexto de negócio seguindo o template `docs/onion/shared/business_context_template.md`, na pasta canônica `docs/business-context/`, organizada em 4 camadas (Cliente / Produto / Mercado / Operacional).
...
> Se o input estiver vazio, solicite as fontes ao usuário antes de prosseguir.
