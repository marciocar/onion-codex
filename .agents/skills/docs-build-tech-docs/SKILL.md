...
Gerar a arquitetura de contexto técnico seguindo o template `docs/onion/shared/technical_context_template.md`, na pasta canônica `docs/technical-context/`, organizada em 4 camadas (Núcleo / AI-Context / Domínio / Workflow).
