...
- **Task Manager Abstraction**: `.agents/skills/task-manager/references/README.md`
- **Detector de Provedor**: `.agents/skills/task-manager/references/detector.md`
- **Documentação ClickUp**: `.codex/docs/onion/clickup-integration.md`
