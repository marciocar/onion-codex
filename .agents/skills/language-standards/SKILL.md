...
1. **Consultar documentação existente** em `docs/`, `.agents/skills/`, `.codex/agents/`
...
4. **Sugerir skill de continuação** quando aplicável

### Ao introduzir novos padrões
1. Documentar em `docs/` ou `.agents/`/`.codex/` conforme apropriado
2. Atualizar skills relacionadas se houver
...
- Verificar subagentes especialistas: `@nodejs-specialist`, `@react-developer`, `@zen-engine-specialist`, etc.
...
- Skills e subagentes devem **funcionar sem integrações** quando possível
