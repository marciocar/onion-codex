...
- Certifique-se de que existe uma pasta .codex/sessions/<feature-slug>
...
Uma vez que tenha um bom entendimento do que está sendo construído, salve-o no arquivo .codex/sessions/<feature-slug>/context.md e peça ao humano para revisar.
...
Uma vez que tenha um bom entendimento do que está sendo construído, salve-o no arquivo .codex/sessions/<feature-slug>/architecture.md e peça ao humano para revisar.
...
1. **Context.md**: Lê task-id do arquivo `.codex/sessions/[slug]/context.md`
...
- Abstração: `.agents/skills/task-manager/references/`
- Detector: `.agents/skills/task-manager/references/detector.md`
