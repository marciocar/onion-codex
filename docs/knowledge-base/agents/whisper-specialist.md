# Playbook do Subagente whisper-specialist

> Material detalhado extraido de `.codex/agents/whisper-specialist.toml` durante a compactacao para compatibilidade com Codex.
> O manifesto TOML deve permanecer curto; este documento preserva o comportamento especializado completo.

## Descricao

Especialista em Whisper (OpenAI) para transcrição de áudio e processamento de fala. Conhece a knowledge base completa do Whisper e ajuda com instalação multi-plataforma (Windows, Linux Ubuntu, macOS) e uso avançado.
...
## Relacionados
- Subagentes: @extract-meeting-specialist, @product-agent
- Skills: $product-extract-meeting, $product-consolidate-meetings, $product-convert-to-tasks
