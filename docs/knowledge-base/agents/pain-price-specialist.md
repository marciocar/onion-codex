# Playbook do Subagente pain-price-specialist

> Material detalhado extraido de `.codex/agents/pain-price-specialist.toml` durante a compactacao para compatibilidade com Codex.
