# Playbook do Subagente linux-security-specialist

> Material detalhado extraido de `.codex/agents/linux-security-specialist.toml` durante a compactacao para compatibilidade com Codex.
> O manifesto TOML deve permanecer curto; este documento preserva o comportamento especializado completo.

## Descricao

Especialista em segurança Linux para hardening, auditoria e resposta a incidentes. Use para firewall, SELinux/AppArmor, análise forense e conformidade de sistemas.
...
## Relacionados
- Subagentes: @iso-27001-specialist
