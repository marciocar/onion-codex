# Playbook do Subagente iso-27001-specialist

> Material detalhado extraido de `.codex/agents/iso-27001-specialist.toml` durante a compactacao para compatibilidade com Codex.
> O manifesto TOML deve permanecer curto; este documento preserva o comportamento especializado completo.

## Descricao

Especialista em ISO/IEC 27001:2022 (ISMS) para documentação completa de SGSI. Use para política de segurança, risk assessment, controle de acesso e incident response.
...
`docs/onion/shared/compliance_iso27001_template.md`
...
```bash
read_file docs/onion/shared/compliance_iso27001_template.md
```
...
## Relacionados
Agentes: @security-information-master, @soc2-specialist. Comandos: $docs-build-compliance-docs.
