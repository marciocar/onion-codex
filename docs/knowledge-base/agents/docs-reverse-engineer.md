# Playbook do Subagente docs-reverse-engineer

> Material detalhado extraido de `.codex/agents/docs-reverse-engineer.toml` durante a compactacao para compatibilidade com Codex.
> O manifesto TOML deve permanecer curto; este documento preserva o comportamento especializado completo.

## Descricao

Especialista em engenharia reversa de projetos para análise estrutural e documentação. Use para detecção de stack e geração de docs consolidada de qualquer projeto.
...
## Relacionados
- Subagentes: @system-documentation-orchestrator, @c4-architecture-specialist
- Skills: $docs-reverse-consolidate
