# Playbook do Subagente docker-specialist

> Material detalhado extraido de `.codex/agents/docker-specialist.toml` durante a compactacao para compatibilidade com Codex.
> O manifesto TOML deve permanecer curto; este documento preserva o comportamento especializado completo.

## Descricao

Especialista em Docker, containerização de apps Node.js/Next.js, Docker Compose e integração com PostgreSQL.
...
## Relacionados
Agentes: @postgres-specialist, @devops-engineer.
