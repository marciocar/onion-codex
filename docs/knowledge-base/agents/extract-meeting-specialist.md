# Playbook do Subagente extract-meeting-specialist

> Material detalhado extraido de `.codex/agents/extract-meeting-specialist.toml` durante a compactacao para compatibilidade com Codex.
...
Agentes: @product-agent, @task-specialist, @storytelling-business-specialist. Skills: $product-task, $docs-build-tech-docs.
