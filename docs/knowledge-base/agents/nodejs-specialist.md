# Playbook do Subagente nodejs-specialist

> Material detalhado extraido de `.codex/agents/nodejs-specialist.toml` durante a compactacao para compatibilidade com Codex.
> O manifesto TOML deve permanecer curto; este documento preserva o comportamento especializado completo.

## Descricao

Especialista em backend Node.js/TypeScript com PNPM e performance optimization. Use para APIs complexas, configurações backend e otimizações Node.js.
...
## Relacionados
- Subagentes: @react-developer, @nx-monorepo-specialist
- Skills: $engineer-start, $engineer-work
