# Playbook do Subagente gitflow-specialist

> Material detalhado extraido de `.codex/agents/gitflow-specialist.toml` durante a compactacao para compatibilidade com Codex.
> O manifesto TOML deve permanecer curto; este documento preserva o comportamento especializado completo.

## Descricao

Especialista em GitFlow para branching, releases e versionamento semântico. Use para guidance em workflows Git estruturados e colaborativos.
...
## Relacionados
- Subagentes: @code-reviewer
- Skills: $git-init, $git-feature-start, $git-release-start
