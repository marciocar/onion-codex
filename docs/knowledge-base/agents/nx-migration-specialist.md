# Playbook do Subagente nx-migration-specialist

> Material detalhado extraido de `.codex/agents/nx-migration-specialist.toml` durante a compactacao para compatibilidade com Codex.
> O manifesto TOML deve permanecer curto; este documento preserva o comportamento especializado completo.

## Descricao

Especialista em migração segura de NX Monorepo (v19+ para v21+). Use para resolver breaking changes, validar workspace e upgrades NX.
...
## Relacionados
- Subagentes: @nx-monorepo-specialist
