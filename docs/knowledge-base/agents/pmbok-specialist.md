# Playbook do Subagente pmbok-specialist

> Material detalhado extraido de `.codex/agents/pmbok-specialist.toml` durante a compactacao para compatibilidade com Codex.
> O manifesto TOML deve permanecer curto; este documento preserva o comportamento especializado completo.

## Descricao

Especialista em PMBOK Guide 7th Edition para documentação de governança de projetos. Use para change management, quality management, stakeholder e risk management.
...
`docs/onion/shared/compliance_pmbok_template.md`
...
```bash
read_file docs/onion/shared/compliance_pmbok_template.md
read_file nx.json
...
## Relacionados
Agentes: @security-information-master, @product-agent. Comandos: $docs-build-compliance-docs.
