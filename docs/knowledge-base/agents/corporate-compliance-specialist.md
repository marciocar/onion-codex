# Playbook do Subagente corporate-compliance-specialist

> Material detalhado extraido de `.codex/agents/corporate-compliance-specialist.toml` durante a compactacao para compatibilidade com Codex.
> O manifesto TOML deve permanecer curto; este documento preserva o comportamento especializado completo.

## Descricao

Especialista em compliance corporativo: anticorrupção, PLD/KYC, ética e governança. Use para revisar políticas, analisar riscos e criar documentação de conformidade.
