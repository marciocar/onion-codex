# Playbook do Subagente postgres-specialist

> Material detalhado extraido de `.codex/agents/postgres-specialist.toml` durante a compactacao para compatibilidade com Codex.
> O manifesto TOML deve permanecer curto; este documento preserva o comportamento especializado completo.

## Descricao

Especialista em PostgreSQL 17 para triggers, functions, schema e performance. Use para design de banco, migrations e otimização de queries.
