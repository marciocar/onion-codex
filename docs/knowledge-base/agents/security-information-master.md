# Playbook do Subagente security-information-master

> Material detalhado extraido de `.codex/agents/security-information-master.toml` durante a compactacao para compatibilidade com Codex.
> O manifesto TOML deve permanecer curto; este documento preserva o comportamento especializado completo.

## Descricao

Orquestrador de compliance que detecta frameworks (ISO 27001, ISO 22301, PMBOK, SOC2) e delega. Use para análise de requisitos e coordenação de especialistas de compliance.
...
**Template:** Leia e siga `docs/onion/shared/compliance_iso27001_template.md`
...
**Template:** Leia e siga `docs/onion/shared/compliance_iso22301_template.md`
...
**Template:** Leia e siga `docs/onion/shared/compliance_pmbok_template.md`
...
**Template:** Leia e siga `docs/onion/shared/compliance_soc2_template.md`
...
Template esperado: docs/onion/shared/compliance_iso27001_template.md
...
Ação: Verificar se specialist existe em .codex/agents/compliance/
...
## Relacionados
Agentes: @iso-27001-specialist, @iso-22301-specialist, @soc2-specialist, @pmbok-specialist. Comandos: $docs-build-compliance-docs.
