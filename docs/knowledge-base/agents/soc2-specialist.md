# Playbook do Subagente soc2-specialist

> Material detalhado extraido de `.codex/agents/soc2-specialist.toml` durante a compactacao para compatibilidade com Codex.
> O manifesto TOML deve permanecer curto; este documento preserva o comportamento especializado completo.

## Descricao

Especialista em SOC2 Type II (AICPA Trust Services Criteria) para documentação de controles. Use para segurança, disponibilidade, confidencialidade e coleta de evidências.
...
`docs/onion/shared/compliance_soc2_template.md`
...
```bash
read_file docs/onion/shared/compliance_soc2_template.md
...
## Relacionados
Agentes: @security-information-master, @iso-27001-specialist. Comandos: $docs-build-compliance-docs.
