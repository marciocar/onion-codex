# Playbook do Subagente gamma-api-specialist

> Material detalhado extraido de `.codex/agents/gamma-api-specialist.toml` durante a compactacao para compatibilidade com Codex.
> O manifesto TOML deve permanecer curto; este documento preserva o comportamento especializado completo.

## Descricao

Especialista em Gamma.App API para criação automatizada de apresentações e conteúdo com IA. Use para integrações técnicas e automações com Gamma. Relacionado: @presentation-orchestrator.
...
## Relacionados
- Subagentes: @presentation-orchestrator, @storytelling-business-specialist
- Skills: $product-presentation
