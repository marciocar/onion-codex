# Playbook do Subagente nx-monorepo-specialist

> Material detalhado extraido de `.codex/agents/nx-monorepo-specialist.toml` durante a compactacao para compatibilidade com Codex.
> O manifesto TOML deve permanecer curto; este documento preserva o comportamento especializado completo.

## Descricao

Especialista em NX Monorepo para criação de libs/apps e estrutura enterprise. Use para arquitetura tier/scope/type e manutenção de monorepos NX.
...
## Relacionados
- Subagentes: @nx-migration-specialist, @system-documentation-orchestrator
