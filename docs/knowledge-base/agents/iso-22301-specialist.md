# Playbook do Subagente iso-22301-specialist

> Material detalhado extraido de `.codex/agents/iso-22301-specialist.toml` durante a compactacao para compatibilidade com Codex.
> O manifesto TOML deve permanecer curto; este documento preserva o comportamento especializado completo.

## Descricao

Especialista em ISO 22301:2019 (BCMS) para documentação de continuidade de negócios. Use para disaster recovery, crisis management, BCP/DRP e RTOs/RPOs.
...
`docs/onion/shared/compliance_iso22301_template.md`
...
```bash
read_file docs/onion/shared/compliance_iso22301_template.md
