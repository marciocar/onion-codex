...
- [AI Development Guide](AGENTS.meta.md) - Example AGENTS.md file for project level  
...
**Create: `AGENTS.meta.md` (AI Development Guide)**
```markdown
...
/specs/technical/               # or /docs/context/
  ...
  AGENTS.meta.md              # Layer 2: AI development guide
...
**For Codex/Windsurf:**
- Configure `AGENTS.md` or equivalent with project-specific guidelines
