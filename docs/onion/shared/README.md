...
Este diretório contém prompts abrangentes projetados para guiar o Codex na geração automática de arquiteturas completas de documentação para projetos. Estes prompts fazem engenharia reversa da estrutura de documentação multi-arquivo que desenvolvemos.
...
claude --prompt docs/onion/shared/technical.md \
...
claude --prompt docs/onion/shared/business.md \
...
- Referencia os templates abrangentes em `docs/onion/shared/`
...
- `docs/onion/shared/technical_context_template.md`
- `docs/onion/shared/business_context_template.md`
