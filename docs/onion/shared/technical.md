...
Gerar uma arquitetura completa de contexto técnico seguindo o template em `docs/onion/shared/technical_context_template.md`. Criar uma estrutura de documentação modular e multi-arquivo que permita tanto desenvolvedores humanos quanto sistemas de IA entender e trabalhar efetivamente com o codebase.
